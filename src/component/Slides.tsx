...
type SlidesProps<T> = {
  ...
  itemWidth?: number;
  /**
   * renderItem: function nhận 1 item (kiểu T) trả về ReactNode,
   * phần nội dung sẽ được render bên trong <Card> (nên bao gồm ảnh + thông tin).
   *
   * Nếu không truyền renderItem thì Slides sẽ dùng render mặc định
   * (kỳ vọng object có các trường: name, img, view | percent).
   */
